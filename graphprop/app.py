...
from src.phase_0.database.models import (
    BankRow,
    PersonnelRow,
    ProjectRow,
    RegulationRow,
...
from src.phase_0.database.repository import (
    get_all_banks,
    get_all_personnel,
    get_all_projects,
    get_all_regulations,
...
from src.phase_0.models.entities import (
    BankEntity,
    BankProfile,
    EvolutionEvent,
    PersonnelEntity,
...
def _sync_folder_structure() -> None:
    ...
    session = _get_db()
    try:
        from src.phase_0.database.repository import get_all_banks, get_all_projects
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    from src.phase_0.workflow.generator import DocumentGenerator as _DocGen
    from src.phase_0.formatting.renderer import PDFRenderer as _PDFRenderer
